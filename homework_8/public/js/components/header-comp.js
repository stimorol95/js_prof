    ...
    template: `
        <header class="header">
                ...
                <div class="header__right header-right">
                    <button id="menu" class="header__button header-right__menu" @click="showMenu = !showMenu">
                        <svg width="32" height="23" viewBox="0 0 32 23" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" />
                        </svg>
                    </button>
                    <form action="#">
                        <button class="header__button header-right__button">
                         ...
                         <button class="header__button header-right__button"  @click='showCart = !showCart'>
...
Vue.component('SearchComp', {
    ...
    template:
        `
        <div class="header__button header-left__button">
            <form action="#" method="post" @submit.prevent="$root.$refs.products.filter(userSearch)">
            <input type="text" class="header__button header-left__button" placeholder="Search" v-model="userSearch">
                <button header__button header-left__button type="submit">
...
Vue.component('NavComp', {
    template:
        `
        <nav class="header-drop" v-show="$parent.showMenu">
            <div class="header-drop__inner">
                <p class="header-drop__text">Menu</p>
                <ul class="header-drop__list">
                    <li class="header-drop__title">Man</li>
                        <ul class="header-drop__sub">
                            <li><a href="#" class="header-drop__link">Accessories</a></li>
                            <li><a href="#" class="header-drop__link">Bags</a></li>
                            <li><a href="#" class="header-drop__link">Denim</a></li>
                            <li><a href="#" class="header-drop__link">T-Shirts</a></li>
                        </ul>
                    <li class="header-drop__title">Woman</li>
                        <ul class="header-drop__sub">
                            <li><a href="#" class="header-drop__link">Accessories</a></li>
                            <li><a href="#" class="header-drop__link">Jackets & Coats</a></li>
                            <li><a href="#" class="header-drop__link">Polos</a></li>
                            <li><a href="#" class="header-drop__link">T-Shirts</a></li>
                            <li><a href="#" class="header-drop__link">Shirts</a></li>
                        </ul>
                    <li class="header-drop__title">Kids</li>
                        <ul class="header-drop__sub">
                            <li><a href="#" class="header-drop__link">Accessories</a></li>
                            <li><a href="#" class="header-drop__link">Jackets & Coats</a></li>
                            <li><a href="#" class="header-drop__link">Polos</a></li>
                    ...
                    <li class="header-drop__item">
                        <a href="registration.html" class="header-drop__title header-drop__media">Account</a>
                    </li>
                    <li class="header-drop__item">
                        <a href="cart.html" class="header-drop__title header-drop__media">Cart</a>
                    </li>
                </ul>
            </div>
            <div class="header-drop__close">
                <button @click="$parent.showMenu = !$parent.showMenu">
                    <svg width="12" height="12" viewBox="0 0 18 18" fill="#575757"
